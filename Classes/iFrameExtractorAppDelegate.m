...
- (void)applicationDidFinishLaunching:(UIApplication *)application {    
	self.video = [[VideoFrameExtractor alloc] initWithVideo:[Utilities bundlePath:@"reksio.mp4"]];
	[video release];
...
//		[playButton setEnabled:YES];
        ...
        //tutaj dobieram się do uiimage, stąd też mogę przechwycić CGref i storzyć CCTexture2D.
